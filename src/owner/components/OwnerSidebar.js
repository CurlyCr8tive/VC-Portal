...
export function renderOwnerSidebar(container, opts) {
  ...
  const identityLine = sessionEmail
    ? `<div class="sidebar-identity-line">Logged in as ${escapeHtml(sessionEmail)}</div>`
    : "";
  ...
  container.innerHTML = `
    ...
    <div class="sidebar-brand">
      ...
      <span>
        ...
        <span class="brand-tagline">Visibility. Strategy. Impact.</span>
      </span>
    </div>
    ...
    <div class="sidebar-support-card">
      ...
      <button type="button" data-action="support">Contact Team</button>
    </div>
  ...
  container.querySelector('[data-action="support"]').addEventListener("click", () => {
    window.location.href = "mailto:tenyse@verifiedconsulting.com?subject=Verified%20Consulting%20Portal%20Support";
  });
