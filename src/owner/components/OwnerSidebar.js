...
export function renderOwnerSidebar(container, opts) {
  ...
  // tenyse@verifiedconsulting.com" while every panel on the page told her to
  // sign in. Both statements were generated by the same page and they
  // contradicted each other, which reads as the app being broken rather
  // than as a preview mode working correctly. A demo session holds no
  // Supabase JWT, so it genuinely is not signed in — say that.
